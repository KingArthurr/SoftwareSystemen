...
public class Board {
    ...
    public boolean hasDiagonal(Mark m) {
    	...
    	// hier niet DIM * DIM maar DIM + DIM omdat het anders 8 kan worden en dit field Mark.EMPTY is
    ...
    public boolean hasWinner() {
    	if (hasRow(Mark.XX) || hasColumn(Mark.XX) || hasDiagonal(Mark.XX)) {
    		return true;
    	}
    	else if (hasRow(Mark.OO) || hasColumn(Mark.OO) || hasDiagonal(Mark.OO)) {
    		return true;
    	}
        return false;
    }

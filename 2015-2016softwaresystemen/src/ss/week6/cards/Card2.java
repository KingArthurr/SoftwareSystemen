...
public class Card2
{
	...
	public static void main(String[] args) {
		Card2 card1 = new Card2(CLUBS, rankString2Char("2"));
		Card2 card2 = new Card2(HEARTS, JACK);
		Card2 card3 = new Card2(SPADES, rankString2Char("10"));
		Card2 card4 = new Card2(DIAMONDS, ACE);
		PrintWriter output = null;
		try {
			if (args.length == 0) {
				output = new PrintWriter(System.out);
			} else output = new PrintWriter(new File(args[0]));
		} catch (Exception e) {
			e.printStackTrace();
		}
		try {
	...
	public static Card2 read(BufferedReader in) throws EOFException {
		...
		scan.close();
		return new Card2(suitString2Char(suit), rankString2Char(rank));
	}
	
	public static Card2 read(DataInput in) throws EOFException {
	...
	public void write(ObjectOutput writer) throws IOException {
		if (writer != null) {
			writer.writeObject(this.toString());
			writer.flush();
		} else {
			throw new IOException();
		}
	...
	public static Card2 read(ObjectInput in) throws EOFException {
		if (in == null) return null;
		String data;
		try {
			data = in.readUTF();
    ...
    */
	 ...
	 */
	public boolean ltSuit(Card2 card) {
	 ...
	 */
	public boolean ltRank(Card2 card) {
	 ...
	 */
	public boolean isInRankBefore(Card2 card) {
